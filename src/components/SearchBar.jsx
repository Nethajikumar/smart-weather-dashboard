...
const SearchBar = () => {
  ...
  return (
    <motion.div 
      ...
      className="w-full max-w-2xl mx-auto mb-8 relative z-50"
      ref={dropdownRef}
    >
      <form onSubmit={handleSearch} className="relative flex items-center w-full">
        ...
        <input
          ...
          className="w-full pl-12 pr-16 py-4 rounded-full glass bg-white/40 dark:bg-black/40 text-gray-800 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all font-medium text-lg"
